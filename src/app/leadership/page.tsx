        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <section className="mb-12" aria-labelledby="spiritual-leaders-heading">
            ...
            <p className="text-[#4a5568] leading-relaxed mb-6">
              Worship leaders and spiritual leaders from established churches across our cities introduce artists—whom we acknowledge as spiritual leaders—at home groups and provide pecha kucha–style messages (10% of our worship) about how God moves through music. They feel called to speak to music as a conduit for transformation, awakening, and encounter with God.
            </p>
          </section>
          ...
          <section className="mb-12" aria-labelledby="artists-leaders-heading">
            ...
            <p className="text-[#4a5568] leading-relaxed mb-6">
              We celebrate artists as spiritual leaders in our community. God has gifted them to lead the 90% music portion of our worship ceremonies, present their spiritual journeys during our home groups, and create space for healing, awakening, and encounter with God. We host local and touring artists and are partnered with Folk Alliance International. We acknowledge artists as developing and developed spiritual leaders who support the wellness, emotional intelligence, and spiritual transformation of audiences. Come meet them.
            </p>
            <Link
              href="/#artists"
          ...
          <section aria-labelledby="home-group-locations-heading">
            <h2 id="home-group-locations-heading" className="text-2xl font-bold text-[#1a1a1a] mb-6">
              Home Group Locations
            </h2>
            <p className="text-[#4a5568] leading-relaxed mb-6">
              Home Group Locations host home groups in their neighborhoods. They register on this site, are approved by admin, and request to host artists on specific dates and times. They facilitate worship ceremonies that are 90% music and 10% message, welcoming church members to bring their own drink and food and workshop alongside artists.
            </p>
            <Link
